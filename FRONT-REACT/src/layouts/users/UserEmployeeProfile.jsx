...
export default function UserEmployeeProfile() {
  ...
  return (
    <div>
      <h2>👤 Mi Perfil de Empleado 👤</h2>

      <div className="flex justify-content-between align-items-center mb-3">
        <Link to="/usuarios/empleado/horarios">
          <Button label="Ver Mis Horarios" icon="pi pi-clock" className="p-button-rounded p-button-success" />
        </Link>

        <Link to="/usuarios/empleado/solicitudes-horarios">
          <Button label="Ver Mis Solicitudes de Horarios" icon="pi pi-calendar" className="p-button-rounded p-button-warning" />
        </Link>
