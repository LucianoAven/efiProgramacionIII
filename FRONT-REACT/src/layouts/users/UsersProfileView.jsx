...
export default function UsersProfileView() {
  ...
  return (
    <div className="flex flex-column" style={{ padding: '2rem' }}>
      {/* Marco tipo cuadro */}
      <div className="profile-frame">

        <h2>
          <i className="pi pi-user" /> Mi Perfil <i className="pi pi-user" />
        </h2>
        ...
        <div className="flex justify-content-end align-items-center mb-2">
          ...
          {currentUser ? (
            <DataTable value={[currentUser]} className="p-datatable-sm p-shadow-2">
